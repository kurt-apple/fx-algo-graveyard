...
//An experiment I did to try to get bots to self-optimize. Shelved for now
...
//extern int ATR_02 = 15; too many variables to optimize
...
string PathToTester = TerminalInfoString(TERMINAL_DATA_PATH)+"/MQL4/Files/Report";
...
void OnInit()
{	Comment(" ");
	/*use only for test*/Tester(TestDays, NameOfBot, NameOfTestSet, PathToTester, TimeOutLevel, Gross_Profit_Amount, Profit_Factor_Amount, Expected_Payoff_Amount, Per_1, Per_2, Per_3, Per_4, Per_5, Per_6, Per_7);
	/*use only for test*/ExpertRemove();
}
